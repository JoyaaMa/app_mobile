  ...
  return (
    <>
      <Tabs initialRouteName="homeScreen" screenOptions={{
        ...
        <Tabs.Screen name="homeScreen" options={{ tabBarLabel: 'Inicio', tabBarIcon: () => (<MaterialCommunityIcons name= 'home' color='grey' size={30}/>), }} />
        ...
        <Tabs.Screen name="configuracao" options={{ title: 'Configurações', tabBarIcon: () => (<MaterialCommunityIcons name= 'cog' color='grey' size={30} />) }}/>
